namespace TaskManagement.Infra.Data.Repositories.Common;

public abstract class RepositoryAsync<TEntity, TId> : Repository<TEntity, TId>, IRepositoryAsync<TEntity, TId> 
